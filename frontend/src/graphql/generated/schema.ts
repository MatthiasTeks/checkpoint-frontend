...
export type AddCountryMutation = { __typename?: 'Mutation', addCountry: { __typename?: 'Country', code: string, emoji: string, name: string, continent?: { __typename?: 'Continent', name: string } | null } };
...
export type GetCountryByCodeQuery = { __typename?: 'Query', country: { __typename?: 'Country', name: string, id: number, emoji: string, code: string, continent?: { __typename?: 'Continent', id: number, name: string } | null } };
